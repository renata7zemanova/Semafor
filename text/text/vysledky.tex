...
Proto je napětí z baterie pomocí rezistorového děliče převedeno na rozsah 0 až 600 mV. Zde je pomocí AD převodníku napětí na baterii měřeno. Spodní rezistor děliče byl
...
Tomu odpovídá maximální napětí na AD převodníku 0,63 V, což je stále v možném měřeném rozsahu. 
...
připojení těchto rezistorů nesmí připojit napájecí napětí 5 V \cite{USB-C}. 
