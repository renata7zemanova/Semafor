...
WiFi modul obsahuje jako jediný mikrokontrolér z řady ESP32. Je také nabízen za cenu, která je v porovnání z ostatními nízká a v porovnání s nabízenými parametry bezkonkurenční. 
Pro zařízení Semaforu je také se svým počtem periferií dostačující. 
%další zajímavé parametry ESP32
