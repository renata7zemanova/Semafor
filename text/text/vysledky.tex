...
Na pin GPIO4 je připojeno měření napětí na baterii. Na tomto pinu je k dispozici AD převodník s hodnotou referenčního napětí XXX \cite{ESP_C3_tech_ref}. Hodnota rezistorového 
děliče byla tedy přizpůsobena tomuto rozsahu možného měřeného napětí. 
