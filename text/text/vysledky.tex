...
Jednalo se o %doplnit součástky, které jsem osazovala ručně 
%místo vypínače byly osazeny kolíky a deska je zapínána pomocí jumperu (propojky)
...
Poté byla DPS naprogramována a vše bylo na první pokus funkční. Komunikace mezi počítačem a mikrokontrolérem proběhla bezproblémově. Byl napsán testovací SW pro programovatelné LED 
...
Dále bylo testováno zapojení kapacitních tlačítek a jejich čtení. 
%nefunguje čtení tlačítek 
%výpis pro debug
%použití pinů pro LoRa, která prozatím nebyla testována
...
Hru Vábnička lze hrát ve třech režimech. Nastavení režimu probíhá v konfiguračním menu. Režimy jsou popsány níže. 
\begin{itemize} %lepší by byly čísla
