...
Z takto vytvořeného modelu byla vytvořena forma. Byl nakreslen válec, který končil vždy v polovině vyčnívajících součástí. Poté byl použit nástroj "Kombinovat", který umožnil odečtení vytvořeného 
modelu DPS s obalem, takže vznikla forma pro potřebný tvar. Druhá polovina formy byla vytvořena stejným způsobem.
