...
\begin{acronym}[KolikMista]
	...
	\acro{HTML}{Hyper Text Markup Language - hypertextový znakovací jazyk, který se používá v vytváření webových stránek}
	\acro{IoT}{Internet of Things - internet věcí}
	\acro{IP}{Internet Protocol - internetový protokoů}
