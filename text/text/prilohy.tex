\chapter{Blokové schéma zapojení elektroniky}

\begin{figure}[!h]
	\begin{center}
	  \includegraphics[scale=1.2]{obrazky/vysledne_blokove_schema_priloha.jpg}
	\end{center}
	\caption[Blokové schéma zapojení elektroniky Semaforu]{Blokové schéma zapojení elektroniky Semaforu.}
\end{figure}

%\includepdf[pages=1]{prilohy/cele_schema}
